...
void add_k_retic(node* tree, vector<vector<vector<int>>> prs, int k, double& prob, double eps, vector<int>& rtcs, bool& pos_k); //Процедура добавления k ретикуляций в дерево
